...
import { sectionsApi } from '@/lib/api/chapters.api';
...
const SectionAddPage = () => {
  ...
  const { id, chapterId, lessonId } = useParams<{ id: string; chapterId: string; lessonId: string }>();
  ...
  const handleSave = async () => {
    ...
    setSubmitting(true);
    try {
      await sectionsApi.create(courseId, chapterIdNum, lessonIdNum, {
        title: title.trim(),
...
export { SectionAddPage as Component };

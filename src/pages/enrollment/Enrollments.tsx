        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="grid grid-cols-24 gap-4 enrollment-item sources-item-label enrollment-item-label">
              ...
              <div className="hidden         xl:flex 2xl:flex               xl:col-span-3 2xl:col-span-2 items-center card-header-title">Create Date</div>
              <div className="hidden                 2xl:flex                             2xl:col-span-2 items-center card-header-title">Phone Number</div>
              <div className="hidden         xl:flex 2xl:flex               xl:col-span-3 2xl:col-span-2 items-center card-header-title">Payment Proof</div>
              <div className="hidden lg:flex xl:flex 2xl:flex lg:col-span-4 xl:col-span-4 2xl:col-span-4 items-center card-header-title">Action</div>
            </div>
            ...
            {enrollments.map((enrollment: IRegistrationContent) => {
              ...
              return (
                <div key={enrollment.id} className="grid grid-cols-24 gap-4 enrollment-item cursor-pointer">
                  ...
                  <div className="col-span-12 md:col-span-13      lg:col-span-8 xl:col-span-7 2xl:col-span-8 flex items-center">
                  ...
                  <div className="hidden         xl:flex 2xl:flex               xl:col-span-3 2xl:col-span-2 items-center cursor-pointer">
                  ...
                  <div className="hidden         xl:flex 2xl:flex               xl:col-span-3 2xl:col-span-2 items-center cursor-pointer">
                    {enrollment.paymentProof && enrollment.paymentProof.imageUrl ? (
                      <div className="enrollment-item-payment-proof" title="Payment Proof" style={{ backgroundImage: `url(${enrollment.paymentProof.imageUrl})` }} />
                    ) : (
                      'N/A'
                    )}
                  </div>
